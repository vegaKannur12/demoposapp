...
import 'package:demoposapp/model/productdetails_model.dart';
...
///////remark table//////////////////////
  ...
  Future<Database> get database async {
    ...
    _database = await _initDB("demoposapp.db");
    return _database!;
  }
...
////////////////////////////////////////////////////
  ...
  backupDB() async {
    ...
    try {
      File ourDbFile =
          File('/data/user/0/com.example.demoposapp/databases/demoposapp.db');
      Directory? folderPathforDBfile =
          Directory('/storage/emulated/0/demoposappDatabses/');
      await folderPathforDBfile.create();
      await ourDbFile.copy('/storage/emulated/0/demoposappDatabses/demoposapp.db');
    } catch (e) {
  ...
  restoreDB() async {
    ...
    try {
      File saveDBFile =
          File('/storage/emulated/0/demoposappDatabses/demoposapp.db');

      await saveDBFile
          .copy('/data/user/0/com.example.demoposapp/databases/demoposapp.db');
    } catch (e) {
      print("exce-=-------${e.toString()}");
    }
  }
