...
import 'package:demoposapp/components/common_popup.dart';
...
import 'package:flutter/material.dart';
import 'package:demoposapp/components/customSnackbar.dart';
import 'package:demoposapp/components/sunmi.dart';
import 'package:demoposapp/db_helper.dart';
import 'package:demoposapp/model/accounthead_model.dart';
import 'package:demoposapp/model/productCompany_model.dart';
import 'package:demoposapp/model/productUnitsModel.dart';
import 'package:demoposapp/model/productsCategory_model.dart';
import 'package:demoposapp/model/registration_model.dart';
import 'package:demoposapp/model/settings_model.dart';
import 'package:demoposapp/model/sideMenu_model.dart';
import 'package:demoposapp/model/userType_model.dart';
import 'package:demoposapp/model/verify_registrationModel.dart';
import 'package:demoposapp/model/wallet_model.dart';
import 'package:demoposapp/screen/ADMIN_/adminModel.dart';
import 'package:demoposapp/screen/ORDER/2_companyDetailsscreen.dart';
import 'package:demoposapp/screen/ORDER/externalDir.dart';
...
//////////////////GET ORDER NUMBER///////////////////////////////////
  ...
  ///////////////GET BAG DETAILS/////////////////////
  getBagDetails(String customerId, String os, String type, BuildContext context,
      String areaId, String areaName, String date, String time) async {
    ...
    if (type == "from save") {
      if (bagList.length > 0) {
        showDialog(
          context: context,
          builder: (BuildContext context) => orderpopup.buildPopupDialog(
            "sale order",
            context,
            "Confirm your order?",
            areaId,
...
// print("jhfdjkhfjd----$bagList");
      ...
      if (newList.length > 0) {
        ...
        if (type == "sale order") {
          List lis =
              await getBagDetails(customerId, os, "", context, "", "", "", "");
